...
* [Решение](#решение)
  ...
  * [Получение CDR отчета](#получение-cdr-отчета)
...
> tl;dr:
>
> JAR доступен в [Releases](https://github.com/TemaSaur/CallStat/releases/latest). После запуска документация доступна по `http://localhost:8080/docs`.
...
10. [x] Конечное решение размещаете на репозитории в github в виде проекта и jar файла с зависимостями;
...
* Нативные запросы к базе данных вместо вычислений в Java (см. `com.github.temasaur.callstat.repository.RecordRepository`)
* Более гибкий выбор дат для отчетов
* Добавление валидации запросов, гибкая обработка ошибок
* Логирование
